...
projects_d12-bot =
  ...
  .desc = Utility and entertainment Telegram bot (Currently not working)
projects_sfv-fix =
...
projects_targets =
  .name = Targets
  .desc = Easily manage your sprites, clones, and their properties
...
page-index_sections_projects_more =
  .text = More projects
page-index_sections_skills = Things that I know
