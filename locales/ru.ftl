...
projects_d12-bot =
  ...
  .desc = Утилитно-развлекательный Telegram бот (Не работает на текущий момент)
projects_sfv-fix =
...
projects_targets =
  .name = Targets
  .desc = С лёгкостью управляйте вашими спрайтами, клонами и их свойствами
...
page-index_sections_skills = То, что я знаю
